...
nau_course_certificate_data_dict = {
  ...
  "organization_long_name": context.get('organization_long_name', ''),
  "document_title": context.get('document_title', ''),
  "location": context.get('location', ''),
  "certificate_background": context.get('certificate_background', ''),
  "add_course_image_left_panel": context.get('add_course_image_left_panel', ''),
  "add_course_name_left_panel": context.get('add_course_name_left_panel', ''),
  "add_organization_logo_to_header": context.get('add_organization_logo_to_header', ''),
  "full_course_image_url": context.get('full_course_image_url', ''),
  "organization_logo_max_height": context.get('organization_logo_max_height', ''),
  "organization_logo_max_width": context.get('organization_logo_max_width', ''),
  "footer_additional_logo": context.get('footer_additional_logo', ''),
  "footer_information_color": context.get('footer_information_color', ''),
  "footer_information_date_title_color": context.get('footer_information_date_title_color', ''),
  "footer_information_date_value_color": context.get('footer_information_date_value_color', ''),
  "footer_information_id_title_color": context.get('footer_information_id_title_color', ''),
  "footer_information_id_value_color": context.get('footer_information_id_value_color', ''),
  "footer_financiers_asset_logo": context.get('footer_financiers_asset_logo', ''),
  "footer_note_certification_information": context.get('footer_note_certification_information', ''),
  "certificate_side_message": context.get('certificate_side_message', ''),
  "certificate_side_message_color": context.get('certificate_side_message_color', ''),
  "supplement": context.get('supplement', ''),
}
if supplement:
